...
class LibraryBrowser : public QObject {
    ...
    Q_PROPERTY(int currentTab READ currentTab NOTIFY currentTabChanged FINAL)
    Q_PROPERTY(QString browseContext READ browseContext NOTIFY browseContextChanged FINAL)
    Q_PROPERTY(QString currentLibraryId READ currentLibraryId NOTIFY currentLibraryIdChanged FINAL)
    Q_PROPERTY(QString currentLibraryType READ currentLibraryType NOTIFY currentLibraryIdChanged FINAL)
    Q_PROPERTY(int movieCount READ movieCount NOTIFY movieCountChanged FINAL)
    Q_PROPERTY(int seriesCount READ seriesCount NOTIFY seriesCountChanged FINAL)
    Q_PROPERTY(int episodeCount READ episodeCount NOTIFY episodeCountChanged FINAL)
    Q_PROPERTY(int totalItems READ totalItems NOTIFY totalItemsChanged FINAL)
    Q_PROPERTY(bool canLoadMore READ canLoadMore NOTIFY totalItemsChanged FINAL)
    Q_PROPERTY(QVariantList latestSections READ latestSections NOTIFY latestSectionsChanged FINAL)
    ...
    Q_PROPERTY(bool filterFavorites READ filterFavorites WRITE setFilterFavorites NOTIFY filterFavoritesChanged FINAL)
    Q_PROPERTY(int filterPlayed READ filterPlayed WRITE setFilterPlayed NOTIFY filterPlayedChanged FINAL)
